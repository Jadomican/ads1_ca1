...
*
*	Utilises dirent.h by Toni Rönkkö https://github.com/tronkko/dirent/blob/master/include/dirent.h
*/
...
int main()  // All parts of program coded by Jason and Robert
{
	...
	***************************************************************************************/
	...
	SimilarityIndex array_of_indexes[kMaxNumFiles];  // Array of structs to hold details for each file
	...
	const double kPlagiarismPercent = 0.15;  // Percentage range of similarity checked (+ or -)
	...
	while (continue_run)
	{
		...
		***************************************************************************************/
		...
		else  // Else continue
		{
			...
			***************************************************************************************/
			...
			for (int i = 0; i < count_files; i++)
			{
				...
				cout << "\t\t\t   -----\n";
				if (array_of_indexes[i].index_metric <= 0) // If metric is 0 (no lines etc.)
				{
					cout << "   Index Metric:\t   N/A\n";
				}
				else  // Format print statement to 2 decimal places for readability
		...
		cout << "Would you like to go again? Y to continue...\nChoice: ";
		cin >> choice;
